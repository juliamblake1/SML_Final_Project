...
renters_2022 <- read.csv("renters_2022_transformed.csv")
train_data <- read.csv("train_transformed.csv")
test_data <- read.csv("test_transformed.csv")
validation_data <- read.csv("validation_transformed.csv")
